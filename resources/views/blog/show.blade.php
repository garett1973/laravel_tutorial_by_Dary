...
<head>
    ...
    <meta
        name="description"
        content="{{ $post->meta->meta_description ? $post->meta->meta_description : "Laravel App" }}"
    />
    <meta
        name="keywords"
        content="{{ $post->meta->meta_keywords ? $post->meta->meta_keywords : "Laravel App_Keywords" }}"
    />
    <meta
        name="robots"
        content="{{ $post->meta->meta_robots ? $post->meta->meta_robots : "Laravel App_Robots" }}"
    <meta
